...
|----------|-------------------|----------------|
| [`gdp_growth_trends.ipynb`](./01_gdp_growth_trends.ipynb) | Which economies show strongest growth patterns? | Time-series analysis, growth rate calculations |
| [`country_gdp_comparison.ipynb`](./02_country_gdp_comparison.ipynb) | How do countries rank economically year-over-year? | Pivot tables, comparative analysis |
| [`economic_recession_analysis.ipynb`](./03_economic_recession_analysis.ipynb) | When did major recessions occur globally? | Negative growth detection, anomaly analysis |
| [`gdp_per_region.ipynb`](./04_gdp_per_region.ipynb) | Which regions drive global economic performance? | Regional aggregation, merging datasets |
...
| Notebook | Business Question | Key Techniques |
|----------|-------------------|----------------|
| [`amazon_product_performance.ipynb`](./05_amazon_product_performance.ipynb) | Which products generate highest customer engagement? | Performance scoring, ranking algorithms |
| [`discount_impact_analysis.ipynb`](./06_discount_impact_analysis.ipynb) | How do discounts affect customer satisfaction? | Binning, correlation analysis |
| [`category_sales_insights.ipynb`](./07_category_sales_insights.ipynb) | Which product categories drive sales volume? | Category analysis, aggregation |
| [`customer_review_sentiment.ipynb`](./08_customer_review_sentiment.ipynb) | What's the overall customer sentiment distribution? | Sentiment classification, thresholding |
| [`amazon_price_optimization.ipynb`](./09_amazon_price_optimization.ipynb) | Which products need pricing strategy adjustments? | Multi-criteria filtering, optimization |
...
| Notebook | Business Question | Key Techniques |
|----------|-------------------|----------------|
| [`cancer_diagnosis_patterns.ipynb`](./10_cancer_diagnosis_patterns.ipynb) | What patterns distinguish diagnostic outcomes? | Statistical grouping, medical data analysis |
| [`cancer_feature_correlation.ipynb`](./11_cancer_feature_correlation.ipynb) | Which medical features are most correlated? | Correlation matrices, heatmap visualization |
| [`cancer_data_cleaning.ipynb`](./12_cancer_data_cleaning.ipynb) | How to ensure data quality in medical datasets? | Missing value handling, outlier treatment |
...
| Notebook | Business Question | Key Techniques |
|----------|-------------------|----------------|
| [`stock_price_trends.ipynb`](./13_stock_price_trends.ipynb) | What are the long-term price movement patterns? | Time-series resampling, trend analysis |
| [`stock_volatility_analysis.ipynb`](./14_stock_volatility_analysis.ipynb) | Which stocks carry highest investment risk? | Volatility calculations, risk metrics |
| [`portfolio_performance.ipynb`](./15_portfolio_performance.ipynb) | How would a diversified portfolio perform? | Portfolio simulation, return calculations |
| [`stock_volume_trends.ipynb`](./16_stock_volume_trends.ipynb) | Which stocks show highest trading activity? | Volume analysis, liquidity metrics |
...
| Notebook | Business Question | Key Techniques |
|----------|-------------------|----------------|
| [`gdp_vs_stock_market.ipynb`](./19_gdp_vs_stock_market.ipynb) | How does economic performance affect stock markets? | Multi-dataset correlation, economic indicators |
| [`ecommerce_vs_economic_trends.ipynb`](./20_ecommerce_vs_economic_trends.ipynb) | Do global economic trends influence e-commerce? | Cross-industry analysis, trend correlation |
